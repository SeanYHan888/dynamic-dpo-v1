...
def main() -> None:
    ...
    results_dir = Path(args.results_dir or output_cfg.get("results_dir", "test/model_judge/results"))
    output_dir = Path(
        args.output_dir or output_cfg.get("visualizations_dir", "test/model_judge/visualizations")
    )

...
**File**: `test/model_judge/data_process_tldr.py`
...
**File**: `test/model_judge/generate_summaries.py`
...
**File**: `test/model_judge/gpt4_oracle.py`
...
**File**: `test/model_judge/analyze_results.py`
...
**File**: `test/model_judge/qualitative_analysis.py`
...
#### [NEW] [data_process_tldr.py](file:///Users/seanmacbook/Research/dpo/dynamic-dpo-v1/test/model_judge/data_process_tldr.py)
...
**Output**: `test/model_judge/data/tldr_eval_set.json`

---

### Component 2: Summary Generation

#### [NEW] [generate_summaries.py](file:///Users/seanmacbook/Research/dpo/dynamic-dpo-v1/test/model_judge/generate_summaries.py)
...
**Output**: `test/model_judge/outputs/all_summaries.json`

---

### Component 3: GPT-4 Oracle Evaluation

#### [NEW] [gpt4_oracle.py](file:///Users/seanmacbook/Research/dpo/dynamic-dpo-v1/test/model_judge/gpt4_oracle.py)
...
**Output**: `test/model_judge/results/{comparison_type}_evaluations.json`
...
#### [NEW] [analyze_results.py](file:///Users/seanmacbook/Research/dpo/dynamic-dpo-v1/test/model_judge/analyze_results.py)
...
**Outputs**:
- `test/model_judge/results/win_rates_summary.csv`
- `test/model_judge/results/evaluation_report.md`

---

### Component 5: Visualization & Reporting

#### [NEW] [visualize_results.py](file:///Users/seanmacbook/Research/dpo/dynamic-dpo-v1/test/model_judge/visualize_results.py)
...
#### [NEW] [config_evaluation.yaml](file:///Users/seanmacbook/Research/dpo/dynamic-dpo-v1/test/model_judge/config_evaluation.yaml)
...
# Output Paths
output:
  data_dir: "test/model_judge/data"
  summaries_dir: "test/model_judge/outputs"
  results_dir: "test/model_judge/results"
  visualizations_dir: "test/model_judge/visualizations"
```
...
python test/model_judge/gpt4_oracle.py \
    ...
    --output test/model_judge/results/sft_vs_standard_dpo.json

python test/model_judge/gpt4_oracle.py \
    --summaries test/model_judge/outputs/all_summaries.json \
    --comparison sft_vs_beta_dpo \
    --output test/model_judge/results/sft_vs_beta_dpo.json

python test/model_judge/gpt4_oracle.py \
    --summaries test/model_judge/outputs/all_summaries.json \
    --comparison sft_vs_dynamic_beta_dpo \
    --output test/model_judge/results/sft_vs_dynamic_beta_dpo.json

# Step 4: Analyze results
python test/model_judge/analyze_results.py \
    --results_dir test/model_judge/results \
    --output test/model_judge/results/evaluation_report.md

# Step 5: Generate visualizations
python test/model_judge/visualize_results.py \
    --results_dir test/model_judge/results \
    --output_dir test/model_judge/visualizations
```
